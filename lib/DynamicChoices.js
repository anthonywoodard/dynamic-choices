...
var DynamicChoices = function DynamicChoices(_ref) {
  ...
  function (_HTMLElement) {
    ...
    _createClass(DynamicChoices, null, [{
    ...
    function DynamicChoices() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(DynamicChoices).call(this));
    }
    ...
    _createClass(DynamicChoices, [{
      ...
      value: function _serverLookup(val) {
        ...
        var apiUrl = this.getAttribute('api-url') || paramConfig.apiUrl;
        var xhrMethod = this.getAttribute('xhr-method') || paramConfig.xhrMethod;
        ...
        if (apiUrl !== '') {
          ...
          xhr.onreadystatechange = function (e) {
            if (xhr.readyState === 4) {
              ...
              if (status === 0 || status >= 200 && status < 400) {
                ...
                var searchValue = _this2.getAttribute('search-value') || paramConfig.searchValue;
                var labelValue = _this2.getAttribute('label-value') || paramConfig.labelValue;
                ...
                if (Array.isArray(results)) {
                  ...
                  _this2._choices.setChoices(results, searchValue, labelValue, true);
          ...
          if (xhrMethod === 'GET' || xhrMethod === 'get') {
            apiUrl = apiUrl + "?".concat(xhrQueryKey + query);
          }
